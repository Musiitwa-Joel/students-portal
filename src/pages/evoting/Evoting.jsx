...
const VotingLoginPage = () => {
  ...
  const handleAuthenticate = () => {
    ...
    setTimeout(() => {
      ...
      messageApi.open({
        type: "success",
        content: "OTP sent to your email and phone number",
      });
  ...
  const handleVerifyOtp = () => {
    ...
    setTimeout(() => {
      ...
      messageApi.open({
        type: "success",
        content:
          "OTP verified successfully. Please review voting instructions.",
      });
          ...
          <div className="voting-instructions-card">
            ...
            <div className="instructions-body">
              <div className="instructions-intro">
                <p>
                  Welcome to the Electronic Voting System. Before you proceed to
                  cast your vote, please take a moment to review the following
                  important information. This will ensure that you understand
                  the voting process and your rights as a voter.
                </p>
              </div>
              ...
              >
                  ...
                  <div className="panel-content">
                    ...
                    <ol className="numbered-list">
                      ...
                      <li>
                        ...
                        candidate per position by clicking on their name or the
                        corresponding selection button.
                      </li>
                      <li>
                        <strong>Review:</strong> Before final submission, you
                        will have the opportunity to review all your selections.
                        Ensure they accurately reflect your intended votes.
                      </li>
                      <li>
                        <strong>Confirmation:</strong> After reviewing, confirm
                        your selections to cast your vote. This action is final
                  ...
                  <div className="panel-content">
                    ...
                    <ul className="bullet-list">
                      <li>
                        ...
                        your preferred candidate's name or the selection button
                        next to it.
                      </li>
                      <li>
                        <strong>Visual Confirmation:</strong> A visual indicator
                        will appear to confirm your selection for each position.
                      </li>
                      <li>
                      ...
                      <li>
                        <strong>Abstaining:</strong> If you wish to abstain from
                        voting for a particular position, select the "Abstain"
                ...
                >
                  <div className="panel-content">
                    <p>Your security and privacy are our highest priorities:</p>
                    <ul className="bullet-list">
                      <li>
                      ...
                      <li>
                        ...
                        industry-standard protocols to ensure the integrity and
                        confidentiality of your vote.
                      </li>
                      <li>
                        <strong>Secure Authentication:</strong> The multi-factor
                        authentication process (including OTP) ensures that only
                        eligible voters can access the system.
                      </li>
                      <li>
                      ...
                      <li>
                        ...
                        anonymity, the system maintains a secure audit trail to
                        verify the integrity of the election process.
                      </li>
                    </ul>
                  </div>
                </Panel>
                ...
                >
                  <div className="panel-content">
                    ...
                    <ul className="bullet-list">
                      <li>
                        <strong>Single Vote:</strong> You can only vote once in
                        this election. Once your ballot is submitted, you cannot
                        vote again.
                      </li>
                      <li>
                        <strong>Session Timeout:</strong> For security reasons,
                        your voting session will expire after 15 minutes of
                        inactivity. If this happens, you will need to
                        authenticate again.
                      </li>
                      <li>
                        <strong>Device Compatibility:</strong> The voting system
                        works on most modern devices and browsers. For optimal
                        experience, use the latest version of Chrome, Firefox,
                        Safari, or Edge.
                      </li>
                      <li>
                        <strong>Technical Issues:</strong> If you encounter any
                        technical difficulties during the voting process, please
                        contact the support team immediately at the contact
              ...
              <div className="help-section">
                ...
                <div className="help-content">
                  ...
                  <div className="contact-info">
                    ...
                    <div className="contact-item">
                      <strong>Support Hours:</strong> 8:00 AM - 8:00 PM (Monday
                      - Sunday)
                    </div>
                  </div>
                </div>
                ...
                {showOtpScreen ? (
                            ...
                            onClick={(e) => {
                              ...
                              setTimeout(() => {
                                ...
                                messageApi.open({
                                  type: "success",
                                  content:
                                    "New OTP sent to your email and phone number",
                                });
                              }, 1500);
                            }}
                          >
                  ...
                  <>
                    <div className="login-header">
                      ...
                      <Text className="login-subtitle">
                        Ensure these credentials are correct for voting and OTP
                        access.
                      </Text>
                    </div>
                    ...
                    <div className="voter-info-form">
                      <div className="info-item">
                        <label className="info-label">Student Number</label>
